...
mixin _$Goods implements DiagnosticableTreeMixin {
 ...
 int? get id; int? get brandId; int? get categoryId; String? get brandName; String? get categoryName; String? get goodsSn; String? get name; String? get gallery; String? get keywords; String? get goodsBrief; int? get isOnSale; int? get sortOrder; int? get counterPrice; bool? get isNewly; String? get primaryPicUrl; String? get listPicUrl; int? get isHot; String? get goodsUnit; int? get retailPrice; String? get goodsDesc; String? get attributes; int? get addTime; String? get status; int? get salesNum; String? get integralper; int? get homePageFlag; int? get homePageCateCode; String? get homePageCateDesc; int? get stockNum; int? get activityFlag; int? get activityId; int? get goodsType; String? get goodsOwnerMobile; String? get goodsOwnerId; String? get specificationValue; bool? get newProperty;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? brandId,  int? categoryId,  String? brandName,  String? categoryName,  String? goodsSn,  String? name,  String? gallery,  String? keywords,  String? goodsBrief,  int? isOnSale,  int? sortOrder,  int? counterPrice,  bool? isNewly,  String? primaryPicUrl,  String? listPicUrl,  int? isHot,  String? goodsUnit,  int? retailPrice,  String? goodsDesc,  String? attributes,  int? addTime,  String? status,  int? salesNum,  String? integralper,  int? homePageFlag,  int? homePageCateCode,  String? homePageCateDesc,  int? stockNum,  int? activityFlag,  int? activityId,  int? goodsType,  String? goodsOwnerMobile,  String? goodsOwnerId,  String? specificationValue,  bool? newProperty)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _goods() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? brandId,  int? categoryId,  String? brandName,  String? categoryName,  String? goodsSn,  String? name,  String? gallery,  String? keywords,  String? goodsBrief,  int? isOnSale,  int? sortOrder,  int? counterPrice,  bool? isNewly,  String? primaryPicUrl,  String? listPicUrl,  int? isHot,  String? goodsUnit,  int? retailPrice,  String? goodsDesc,  String? attributes,  int? addTime,  String? status,  int? salesNum,  String? integralper,  int? homePageFlag,  int? homePageCateCode,  String? homePageCateDesc,  int? stockNum,  int? activityFlag,  int? activityId,  int? goodsType,  String? goodsOwnerMobile,  String? goodsOwnerId,  String? specificationValue,  bool? newProperty)  $default,) {final _that = this;
switch (_that) {
case _goods():
return $default(_that.id,_that.brandId,_that.categoryId,_that.brandName,_that.categoryName,_that.goodsSn,_that.name,_that.gallery,_that.keywords,_that.goodsBrief,_that.isOnSale,_that.sortOrder,_that.counterPrice,_that.isNewly,_that.primaryPicUrl,_that.listPicUrl,_that.isHot,_that.goodsUnit,_that.retailPrice,_that.goodsDesc,_that.attributes,_that.addTime,_that.status,_that.salesNum,_that.integralper,_that.homePageFlag,_that.homePageCateCode,_that.homePageCateDesc,_that.stockNum,_that.activityFlag,_that.activityId,_that.goodsType,_that.goodsOwnerMobile,_that.goodsOwnerId,_that.specificationValue,_that.newProperty);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? brandId,  int? categoryId,  String? brandName,  String? categoryName,  String? goodsSn,  String? name,  String? gallery,  String? keywords,  String? goodsBrief,  int? isOnSale,  int? sortOrder,  int? counterPrice,  bool? isNewly,  String? primaryPicUrl,  String? listPicUrl,  int? isHot,  String? goodsUnit,  int? retailPrice,  String? goodsDesc,  String? attributes,  int? addTime,  String? status,  int? salesNum,  String? integralper,  int? homePageFlag,  int? homePageCateCode,  String? homePageCateDesc,  int? stockNum,  int? activityFlag,  int? activityId,  int? goodsType,  String? goodsOwnerMobile,  String? goodsOwnerId,  String? specificationValue,  bool? newProperty)?  $default,) {final _that = this;
switch (_that) {
case _goods() when $default != null:
return $default(_that.id,_that.brandId,_that.categoryId,_that.brandName,_that.categoryName,_that.goodsSn,_that.name,_that.gallery,_that.keywords,_that.goodsBrief,_that.isOnSale,_that.sortOrder,_that.counterPrice,_that.isNewly,_that.primaryPicUrl,_that.listPicUrl,_that.isHot,_that.goodsUnit,_that.retailPrice,_that.goodsDesc,_that.attributes,_that.addTime,_that.status,_that.salesNum,_that.integralper,_that.homePageFlag,_that.homePageCateCode,_that.homePageCateDesc,_that.stockNum,_that.activityFlag,_that.activityId,_that.goodsType,_that.goodsOwnerMobile,_that.goodsOwnerId,_that.specificationValue,_that.newProperty);case _:
  return null;
...
class _goods with DiagnosticableTreeMixin implements Goods {
  const _goods({this.id, this.brandId, this.categoryId, this.brandName, this.categoryName, this.goodsSn, this.name, this.gallery, this.keywords, this.goodsBrief, this.isOnSale, this.sortOrder, this.counterPrice, this.isNewly, this.primaryPicUrl, this.listPicUrl, this.isHot, this.goodsUnit, this.retailPrice, this.goodsDesc, this.attributes, this.addTime, this.status, this.salesNum, this.integralper, this.homePageFlag, this.homePageCateCode, this.homePageCateDesc, this.stockNum, this.activityFlag, this.activityId, this.goodsType, this.goodsOwnerMobile, this.goodsOwnerId, this.specificationValue, this.newProperty});
